...
app.set("views", path.join(__dirname, 'view')); // right hand side is the name i gave, left is the key word
...
function calculateRate(request, response) {
    ...
    var weight = Number(request.query.weight); // how to cast string to an int
